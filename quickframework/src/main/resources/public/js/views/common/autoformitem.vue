<template  >
    <span v-show="show">
        <template v-if="readonly">
            ...
            <el-form-item v-if="cmeta.uiMeta.visable" :label="getLabel(cmeta)" :prop="cmeta.dataKey">
                ...
                <el-upload v-else-if="cmeta.uiMeta.uiType==='Img'" class="upload-demo" action="/" :before-remove="()=>{return false}" :file-list="getupfilelist(cvalue)" ist-type="picture-card">
                </el-upload>
