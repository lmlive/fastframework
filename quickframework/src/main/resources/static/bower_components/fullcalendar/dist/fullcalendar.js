...
/*
GENERAL NOTE on moments throughout the *entire quickframework* of the codebase:
...
var ChronoComponent = Model.extend({
	...
	// `attrs` and `innerHtml` are use to generate the quickframework of the HTML tag.
