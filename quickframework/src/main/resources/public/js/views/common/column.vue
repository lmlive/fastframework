<template>
    ...
    <span v-else>
        ...
        <el-upload v-else-if="cmeta.uiMeta.uiType==='Img'" class="upload-demo" action="uploadUrl" :file-list="getupfilelist(cvalue)" list-type="picture">
            <el-button size="small" type="primary">点击上传</el-button>
            <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
        </el-upload>

        <el-upload v-else-if="cmeta.uiMeta.uiType==='File'" class="upload-demo" action="uploadUrl" :file-list="getupfilelist(cvalue)">
            <el-button size="small" type="primary">点击上传</el-button>
...
define(['vue', 'v!views/common/embedded', 'v!views/common/dictionary'], function(Vue) {
    return Vue.component('l-column', {
        template: template,
        props: ['readonly', 'cmeta', 'value'],
        data() {
            return {
